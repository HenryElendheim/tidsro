...
In development, built in slices. **Slice 1 (countdowns) is implemented and merged**, with polish on top: Settings apply on **Save**, and the running-timer row now has clearer **pause/resume** plus a **Reset**. The full design lives in [`docs/superpowers/specs/2026-06-03-tidsro-design.md`](docs/superpowers/specs/2026-06-03-tidsro-design.md).
